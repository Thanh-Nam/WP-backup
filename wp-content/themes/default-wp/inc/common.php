...
function getPriceAndPercen($price = null,$price_sale = null){
    ...
    if($price > 0 && $price_old > 0){
        if($price_old > $price){
            ...
            $result = [
                'real_price'=> number_format((double)$price,0,',','.') .'đ',
                'price'=>  number_format((double)$price_old,0,',','.') .'đ',
                'percent'=>round($percent)
            ];
        }
        else{
            $result = [
                'real_price'=> number_format((double)$price) .'đ',
                'price'=> "",
                'percent '=>""
            ];
        }
    ...
    elseif($price_old > 0 && $price == 0){
        $result = [
            'real_price' =>  number_format((double)$price_old) .'đ',
            'price' => "",
            'percen' => ""
        ];
    }
